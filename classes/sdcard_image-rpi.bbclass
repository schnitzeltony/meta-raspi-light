...
IMAGE_CMD:rpi-sdimg () {
    ...
    mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/${BOOTFILES_DIR_NAME}/* ::/
    mmd -i ${WORKDIR}/boot.img ${OVERLAYS_DIR_NAME}
    mcopy -i ${WORKDIR}/boot.img -s ${DEPLOY_DIR_IMAGE}/${OVERLAYS_DIR_NAME}/* ::/${OVERLAYS_DIR_NAME}
